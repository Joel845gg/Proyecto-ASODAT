...
<head>
    <meta charset="UTF-8" />
    <title>Buscar Cupo Socio - Sana</title>
    <style>
        body {
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background: url('img/fondosanasana.avif') no-repeat center center fixed;
...
<body>
    <div class="contenedor">
        <form method="post" action="sana.php">
            ...
            <button type="button" onclick="window.location.href='sana.php'">Refrescar</button>
        </form>
